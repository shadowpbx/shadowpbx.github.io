# CompTIA A+ Core 1 (220-1201) Audio Player & Companion Suite

* **Live Player Website**: [https://audio.hexdef.com/A%2B220-1201/](https://audio.hexdef.com/A%2B220-1201/)
* **Written Study Companion**: Access the `companion.html` page from the player or directly at [https://audio.hexdef.com/A%2B220-1201/companion.html](https://audio.hexdef.com/A%2B220-1201/companion.html).

A premium, mobile-responsive, dark-themed HTML5 audio player and companion study suite designed for the **CompTIA A+ Core 1 (220-1201)** curriculum. It features custom track looping, streamlined 5-speed control with persistent rates across tracks, objective chapter grouping, timeline scrubbing, and auto-resuming playback.
...
* ⚡ **Streamlined 5-Speed High-Impact Control**: Instant single-tap cycling through the 5 core study speeds (`1.0x` → `1.1x` → `1.2x` → `0.8x` → `0.9x` → `1.0x`) with double-click reset shortcut. Speed persists seamlessly across all track changes.
* 📚 **Domain Objective Chapter Grouping**: Automatically categorizes all 301 tracks across 27 official CompTIA A+ Core 1 objectives with collapsible headers and total playtime counters.
...
* ☁️ **Cloudflare R2 / S3 Storage Integration**: Stream audio files directly from a public Cloudflare R2 bucket (`https://audio.hexdef.com/A%2B220-1201/`) to keep the repository lightweight.
...
The complete Markdown study guide covering all 5 CompTIA A+ Core 1 (220-1201) Domains:
1. **Domain 1.0: Mobile Devices** (Objectives 1.1, 1.2, 1.3)
2. **Domain 2.0: Networking** (Objectives 2.1 – 2.8)
3. **Domain 3.0: Hardware** (Objectives 3.1 – 3.8)
4. **Domain 4.0: Virtualization & Cloud Computing** (Objectives 4.1, 4.2)
5. **Domain 5.0: Hardware & Network Troubleshooting** (Objectives 5.1 – 5.6)
...
Sub Title: 220-1201 Complete Course & Study Audio
```
...
```bash
python3 generate_playlist.py -d "Audio" -b "https://audio.hexdef.com/A%2B220-1201/"
```
