...
(function() {
    ...
    function ensureHexLeanTopbar() {
        ...
        if (topbarRight && !topbarRight.querySelector('.topbar-hexlean-pill')) {
            ...
            pill.innerHTML = `
                <svg class="hexlean-bolt-icon" width="13" height="13" viewBox="0 0 128 128" fill="none" aria-hidden="true">
                    <path d="M64 8 L114 36 L114 92 L64 120 L14 92 L14 36 Z" fill="currentColor" fill-opacity="0.25" stroke="currentColor" stroke-width="8" stroke-linejoin="round"/>
                    <polygon points="68,24 34,68 64,68 60,104 94,60 64,60" fill="currentColor"/>
                </svg>
