        ...
        <div class="header-container">
            ...
            <nav class="nav-container">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="https://hexlean.com" target="_blank" rel="noopener" class="hexlean-dropdown-link" title="HexLean Interactive Learning & IDE">⚡ HexLean Platform ↗</a>
                ...
                <a href="https://hexlean.com" class="nav-link nav-link-hexlean" target="_blank" rel="noopener" title="HexLean — Interactive Technical Education by Tanvir Hussain">[ ⚡ HEXLEAN ↗ ]</a>
...
def compile_academics_readmes(folder_path):
    ...
    targets = [
        ...
        ("academics_audio/05 CISS 109", "ciss109", "CISS 109: Python Programming"),
        ("academics_audio/06 CISS 120", "ciss120", "CISS 120: Computer Networking & Communications"),
