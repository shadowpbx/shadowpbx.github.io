# Kali Linux Tools Audio Player & Companion Suite
...
A premium, mobile-responsive, dark-themed HTML5 audio player and study companion suite covering **229 Essential Kali Linux Security Tools** across all 13 official application categories. Features custom track looping, speed controls, exclusive category accordion grouping, continuous flat list toggle, and auto-resuming playback.
...
* 📚 **13 Official Category Accordions**: Automatically categorizes all 229 tools into the 13 official Kali Linux categories with auto-collapsing accordions and playtime counters.
...
* 📖 **Written Study Companion**: Access full markdown study notes and tool definitions in a dedicated dashboard (`companion.html`) with multi-theme support (Dark Comfort, Warm Sepia, Light Paper, Auto).
...
The complete Markdown study guide covering all 13 Kali Linux Tool Categories:
...
Sub Title: 229 Security Tools Master Reference Guide
```
