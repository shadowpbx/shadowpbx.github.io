...
*   **Terminal Workstation Cards:** High-contrast cards featuring:
    *   **Top Status Bar:** Left suite badge (`[ SUITE 01 ]`, `[ SUITE 02 ]`, `[ SUITE 03 ]`) and right status pill displaying track count + total runtime (`397 MODULES • 98h 26m`, `71 MODULES • 11h 5m`, `744 MODULES • 82h 51m`).
    *   **Dual Action Buttons:**
